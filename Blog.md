...
| 📓 **Training Notebook (Colab)** | [grpo_train_colab.ipynb](https://github.com/canboyedits/DesignGym/blob/main/training/grpo_train_colab.ipynb) |
...
│   └── grpo_train_colab.ipynb    # Full training notebook ← start here
├── server/
